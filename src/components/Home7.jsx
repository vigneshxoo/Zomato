        ...
        <div className='w-full h-full flex  flex-col justify-center items-center bg-[#F8F8F8]'>
            ...
            <aside className='flex justify-center itmes-center gap-20 p-20'>
                ...
                <div className='leading-8 font-fam '>
                    ...
                    <img className='w-36 h-10 mb-2 ' src="https://b.zmtcdn.com/data/webuikit/9f0c85a5e33adb783fa0aef667075f9e1556003622.png" alt="" />
                    <img className='w-36 h-10 mb-2' src="https://b.zmtcdn.com/data/webuikit/23e930757c3df49840c482a8638bf5c31556001144.png" alt="" />
                </div>
            </aside>
